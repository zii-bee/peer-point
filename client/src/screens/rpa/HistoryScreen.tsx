// src/screens/rpa/HistoryScreen.tsx
...
const RPAHistoryScreen = () => {
  ...
  const renderItem = ({ item }) => {
    ...
    const studentParticipant = item.participants.find(p => 
      p.role === 'user'
    );
  ...
  return (
    <View className="flex-1 bg-gray-50 p-4">
      <Text className="text-2xl font-bold text-primary-800 mb-4">Your Chat History</Text>
...
export default RPAHistoryScreen;