      ...
      <View className="px-6 py-8">
        <View className="items-center mb-8">
          ...
          <View className="bg-purple-100 px-3 py-1 rounded-full mt-2">
            <Text className="text-purple-800">Administrator</Text>
          </View>
        </View>
        ...
        <View className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          <TouchableOpacity className="flex-row items-center p-4 border-b border-gray-100">
            ...
            <View className="flex-1">
              <Text className="text-gray-800 font-medium">System Settings</Text>
              <Text className="text-gray-500 text-sm">Configure system preferences</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
          </TouchableOpacity>

          <TouchableOpacity className="flex-row items-center p-4 border-b border-gray-100">
            <Ionicons name="people-outline" size={24} color="#6b7280" className="mr-4" />
            <View className="flex-1">
              <Text className="text-gray-800 font-medium">User Management</Text>
              <Text className="text-gray-500 text-sm">Manage users and roles</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
          </TouchableOpacity>

          <TouchableOpacity className="flex-row items-center p-4">
            <Ionicons name="analytics-outline" size={24} color="#6b7280" className="mr-4" />
            <View className="flex-1">
              <Text className="text-gray-800 font-medium">Analytics</Text>
              <Text className="text-gray-500 text-sm">View system analytics and reports</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
          </TouchableOpacity>
        </View>
